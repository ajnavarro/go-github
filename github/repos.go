...
type Repository struct {
	...
	ArchiveURL       *string `json:"archive_url,omitempty" bson:",omitempty"`
	AssigneesURL     *string `json:"assignees_url,omitempty" bson:",omitempty"`
	BlobsURL         *string `json:"blobs_url,omitempty" bson:",omitempty"`
	BranchesURL      *string `json:"branches_url,omitempty" bson:",omitempty"`
	CollaboratorsURL *string `json:"collaborators_url,omitempty" bson:",omitempty"`
	CommentsURL      *string `json:"comments_url,omitempty" bson:",omitempty"`
	CommitsURL       *string `json:"commits_url,omitempty" bson:",omitempty"`
	CompareURL       *string `json:"compare_url,omitempty" bson:",omitempty"`
	ContentsURL      *string `json:"contents_url,omitempty" bson:",omitempty"`
	ContributorsURL  *string `json:"contributors_url,omitempty" bson:",omitempty"`
	DeploymentsURL   *string `json:"deployments_url,omitempty" bson:",omitempty"`
	DownloadsURL     *string `json:"downloads_url,omitempty" bson:",omitempty"`
	EventsURL        *string `json:"events_url,omitempty" bson:",omitempty"`
	ForksURL         *string `json:"forks_url,omitempty" bson:",omitempty"`
	GitCommitsURL    *string `json:"git_commits_url,omitempty" bson:",omitempty"`
	GitRefsURL       *string `json:"git_refs_url,omitempty" bson:",omitempty"`
	GitTagsURL       *string `json:"git_tags_url,omitempty" bson:",omitempty"`
	HooksURL         *string `json:"hooks_url,omitempty" bson:",omitempty"`
	IssueCommentURL  *string `json:"issue_comment_url,omitempty" bson:",omitempty"`
	IssueEventsURL   *string `json:"issue_events_url,omitempty" bson:",omitempty"`
	IssuesURL        *string `json:"issues_url,omitempty" bson:",omitempty"`
	KeysURL          *string `json:"keys_url,omitempty" bson:",omitempty"`
	LabelsURL        *string `json:"labels_url,omitempty" bson:",omitempty"`
	LanguagesURL     *string `json:"languages_url,omitempty" bson:",omitempty"`
	MergesURL        *string `json:"merges_url,omitempty" bson:",omitempty"`
	MilestonesURL    *string `json:"milestones_url,omitempty" bson:",omitempty"`
	NotificationsURL *string `json:"notifications_url,omitempty" bson:",omitempty"`
	PullsURL         *string `json:"pulls_url,omitempty" bson:",omitempty"`
	ReleasesURL      *string `json:"releases_url,omitempty" bson:",omitempty"`
	StargazersURL    *string `json:"stargazers_url,omitempty" bson:",omitempty"`
	StatusesURL      *string `json:"statuses_url,omitempty" bson:",omitempty"`
	SubscribersURL   *string `json:"subscribers_url,omitempty" bson:",omitempty"`
	SubscriptionURL  *string `json:"subscription_url,omitempty" bson:",omitempty"`
	TagsURL          *string `json:"tags_url,omitempty" bson:",omitempty"`
	TreesURL         *string `json:"trees_url,omitempty" bson:",omitempty"`
	TeamsURL         *string `json:"teams_url,omitempty" bson:",omitempty"`
